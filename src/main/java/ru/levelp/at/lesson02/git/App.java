...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("2.4 / 2.8 = " + calculator.divide(new BigDecimal(2.4), new BigDecimal(2.8)));
        System.out.println("5.3 / 0.7 = " + calculator.divide(new BigDecimal(5.3), new BigDecimal(0.7)));
        System.out.println("0.0 / 0.7 = " + calculator.divide(new BigDecimal(0.0), new BigDecimal(0.7)));
